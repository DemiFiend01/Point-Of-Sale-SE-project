...
5. Recreate the UML class diagrams:
...
6. How to actually store the orders? 
7. Add menuItem id logic!!
8. Add User id logic!!!
9. Database logic needed to implement actual logic (especially in Actors)
10. Manager report creation
11. Manager database report viewing
